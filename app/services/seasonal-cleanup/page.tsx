...
const faqs = [
  ...
  { question: 'Are estimates really free?', answer: 'Yes. Estimates on new system installs are completely free with no obligation.' },
...
export const metadata: Metadata = buildPageMetadata({
  ...
  description: 'New high-efficiency AC and heating system installation in El Dorado, Arkansas. Free estimates, right-sized systems, and financing available.',
