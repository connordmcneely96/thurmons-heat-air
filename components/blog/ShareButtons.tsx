...
export function ShareButtons({ title }: ShareButtonsProps) {
    // Check window availability for SSG/SSR safety
    ...
    return (
        <div className="flex items-center gap-3 pb-8 border-b border-gray-200 mb-8">
            ...
            <button
                ...
                className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-gray-600 text-white hover:bg-gray-700 transition-colors"
